...
class MonocartProvider {
    ...
    async initialize(ctx) {
        ...
        const coverageReportOptions = config.coverageReportOptions;
        if (typeof coverageReportOptions === 'string') {
            // as a config path
            const data = await import(coverageReportOptions);
            this.coverageReportOptions = data.default || data;
        } else {
            this.coverageReportOptions = coverageReportOptions;
        }
        ...
        this.coverageReport = new CoverageReport(this.coverageReportOptions);
